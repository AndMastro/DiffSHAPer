...
# ### Load data read Shapley values and generate linkers using partial molecules
...
#     atom_indices_to_keep = torch.cat((fragment_atoms_indices_keep, linker_atoms_indices)).to(device)
